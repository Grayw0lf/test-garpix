...
from ticket.filters import UserStatisticFilterSet
from .models import Ticket
from .serializers import TicketSerializer, TicketStateSerializer


class TicketViewSet(mixins.CreateModelMixin, mixins.RetrieveModelMixin,
    ...
    def get_serializer_class(self):
        return self.serializer_class if not self.action == 'change_state' else \
